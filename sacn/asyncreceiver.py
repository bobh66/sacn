...
from sacn.receiving.receiver_handler_async import AsyncReceiverHandler
...
class sACNAsyncReceiver(ReceiverHandlerListener):
    def __init__(self, bind_address: str = '0.0.0.0', bind_port: int = 5568, socket: ReceiverSocketBase = None):
        ...
        self._handler: AsyncReceiverHandler = AsyncReceiverHandler(bind_address, bind_port, self, socket)
    ...
    async def start(self) -> None:
        ...
        await self._handler.socket.start()
